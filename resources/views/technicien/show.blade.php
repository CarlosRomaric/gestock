            ...
            <div class="content-wrapper">
                <div class="card">
                  <div class="card-body">
                    ...
                    @endif
                    <label for="technicien"><h5 class="text-uppercase"><strong>Technicien:</strong> {{ $technicien->nom }} {{ $technicien->prenoms }} Sortie de Produit</h5></label>
                            ...
                            <tbody>
                                    ...
                                    <?php $i++; ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="">{{ $produit->price }} FCFA </td>
