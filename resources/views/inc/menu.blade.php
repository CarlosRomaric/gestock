              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                <a class="dropdown-item py-3">
                  <p class="mb-0 font-weight-medium float-left">
                      Vous avez {{ nbreProduitsInferieurStock() }} produits 
    ...
    <div class="nav-bottom">
      <div class="container">
        <ul class="nav page-navigation">
          ...
          <li class="nav-item">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                ...
                <li class="nav-item"><a class="nav-link" href="/produits">Liste des Produits</a></li>
                <li class="nav-item"><a class="nav-link" href="/sorties">Liste des Bon de sorties de Produits</a></li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link"><i class="link-icon icon-docs"></i><span class="menu-title">A propos</span></a>
          </li>
        </ul>
      </div>
    </div>
